      ...
      {isLogin ? (
        <Row className={`${styles.container}`}>
          <Col md={2} className="d-none d-md-flex">
            <Image src="/segoro.png" width={170} height={75} />
          </Col>
          <Col md={9} lg={7} className={styles.nav}>
            ...
            <Col md={5} className={`${styles.profileBox} d-none d-md-flex`}>
              ...
              <a
                ...
                className={
                  hover === "profile" ? styles.linkActive : styles.link
                }
          ...
          <Col className={`d-flex d-md-none text-center `}>
            <Row className={styles.container}>
              <Col onClick={() => handleHover("home")}>
                ...
                />
                {hover === "home" ? (
                  <p className={styles.titleIcon}>Home</p>
                ) : (
                  ""
                )}
              </Col>
              <Col onClick={() => handleHover("venue")}>
                ...
                />
                {hover === "venue" ? (
                  <p className={styles.titleIcon}>Venue</p>
                ) : (
                  ""
                )}
              </Col>
              <Col onClick={() => handleHover("profile")}>
                ...
                />
                {hover === "profile" ? (
                  <p className={styles.titleIcon}>Profile</p>
                ) : (
                  ""
                )}
              </Col>
