...
export const DetailHeading = ({ page }) => {
    ...
    return (
        <>
            ...
            <Row className={styles.heading}>
                <Col
                    sm={3}
                    className={`${(page === "detail") && styles.headingActive || styles.headingOff} py-auto text-center`}
                ...
                <Col
                    sm={3}
                    className={`${(page === "field") && styles.headingActive || styles.headingOff} py-auto text-center`}
                ...
                <Col
                    sm={3}
                    className={`${(page === "review") && styles.headingActive || styles.headingOff} py-auto text-center`}
